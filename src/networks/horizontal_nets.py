from tensorflow.keras.layers import Input, Lambda, Conv2D, Dense, Flatten, MaxPooling2D, SeparableConv2D
...
class HorizontalNetworkV5():
    ...
    def build_net(self, num_outputs):
        ...
        embedding = apply_quantization(Model(inputs=net_input, outputs=convnet, name="horizontal_blocks"))
        ...
        right_branch = Dense(512, activation="relu", kernel_regularizer=l2(1e-2), kernel_initializer="he_normal", name='right_dense0')(right_branch)
        ...
        left_branch = Dense(512, activation="relu", kernel_regularizer=l2(1e-2), kernel_initializer="he_normal", name='left_dense0')(left_branch)
